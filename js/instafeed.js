...
var processedCaption;
  ...
  function processCaption(caption, length){
    var temp = caption  
    if(caption.length >= length){
        temp = caption.substring(0, length); 
    }
  ...
  function Instafeed(options) {
    ...
    var opts = {
      ...
      success: null,
      target: 'instafeed',
      template: '<div class="gallery-item"><a href="{{link}}"> <img class="gallery-image" title="{{caption}}" src="{{image}}" /> <div class="overlay"></div> <div class="gallery-item-info"><li class="gallery-item-caption">{{proccessedCptn}}</li></div> </a> </div>',
      templateBoundaries: ['{{','}}'],
      transform: null
    };
  ...
  Instafeed.prototype.run = function run() {
    ...
    this._getAccessToken(function onTokenReceived(err, token) {
      ...
      url = 'https://graph.instagram.com/me/media?fields=caption,like_count,id,media_type,media_url,permalink,thumbnail_url,timestamp,username&access_token='+ token;
  ...
  Instafeed.prototype._getItemData = function getItemData(data) {
    ...
    processedCaption = processCaption(data.caption, 110);
      
    return {
      caption: data.caption,
      proccessedCptn: processedCaption,
      id: data.id,
      image: image,
      link: data.permalink,
      model: data,
