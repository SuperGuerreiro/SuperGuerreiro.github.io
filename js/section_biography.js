...
var bio1EN = 'The year of 2018 was followed by more concerts and the recording/production of their first debut EP. With the band participating in the aforementioned Festival da Liberdade. There, they also had the privilege of being interviewed by Rui Unas (a popular portuguese comedian, actor and TV host), on the podcast “Maluco Beleza”. Afterwards, the band participated in the “XXIII Festival de Música Moderna de Corroios” (Corroios’ Festival of Modern Music), and finally in the “Vagos Metal Fest” band contest. With the recording of the EP concluded, the debut single "Breaking The Dogma" was released in August 2018. The end of that year saw some lineup changes, with Filipe and Daniel leaving the band. Not long after, Henrique Simas was recruited to fill in as lead guitarist. Now with both guitarists taking on more concise roles performance wise and in need of a main vocalist, the band decided to try having Renato fill this role, with him focusing on rhythm guitar. Bernardo Rebelo also became the band’s backing vocalist.'

var bio2EN = 'In May of 2019, the self-titled debut EP was finally released. At this point, the changes in the lineup were proving to be fruitful, as the band was infused with a sense of creativity originating from the new possibilities. This lead to a considerate share of the debut album being written and composed during this time. In December of that same year, the band debuted their new lineup in a concert at Cine Incrivel, in Almada. They got to share the stage with their peers over at “The Darkest Fall”, and two well known Portuguese underground bands, Decayed and Sacred Sin. Along with the debut EP, some of the songs that make up the debut album were played.'

var bio3EN = 'In 2020, the plans were laid out for the recording of the album. Unfortunately, due to the COVID-19 pandemic, the process was heavily delayed and left the group uncertain as to when they could get back to work. But after a long waiting period, the band finally resumed the recording of the album in August 2020. In May of 2021, with the production process already well on it’s tracks, the first single was released, entitled "Apostasy": an explosion of sound where the modern meets the old. In July, the second single "Tragedy Befalls" was released, with a more approachable feel yet without dropping their progressive nature. Finally, in August, the third and final single is released, with a more rhythmic and heavier sound put on display. The full record was release in September 7th, 2021.'
